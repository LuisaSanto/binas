...
public class BinasClient implements BinasPortType {
    ...
    /** Colecçao de tickets validos */
    public static TicketCollection ticketCollection = new TicketCollection();
    public static final String VALID_SERVER_NAME = "binas@A58.binas.org";
